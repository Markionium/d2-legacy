describe('Directive: recordtable', function () {
    ...
    describe('recordtable', function () {
        ...
        describe('structure', function () {
            ...
            it('should add a header row for the name', inject(function ($compile) {
                var tableHead;
                var headers;
                var firstHeader;

                //FIXME: Why second compile?
                $compile(element)(scope);
                scope.$digest();

                tableHead = element.find('thead');
                headers = tableHead.children();
                firstHeader = headers.first().children().find('span').first();

                expect(firstHeader.text()).toBe('name');
            }));

            it('should add a column header for each of the keys in the data objects', inject(function ($compile) {
                var tableHeaderRow;
                var headers;
...
//            });
            ...
            it('should generate the columns based on the data if no columns have been predefined', function () {
                ...
                //FIXME: Check why we have to compile twice..
                $compile(element)(scope);
                scope.$digest();
                $compile(element)(scope);
                scope.$digest();
