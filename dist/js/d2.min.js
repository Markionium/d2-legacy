"use strict";!function(d,e){e.utils={scriptPath:function(){var d=document.getElementsByTagName("script"),e=d[d.length-1].src;return e.substring(0,e.lastIndexOf("/")+1)}},d.module("d2-services",["d2-rest"]),d.module("d2-filters",[]),d.module("d2-datatable",["d2-filters"]),d.module("d2-breadcrumbs",[]),d.module("d2-introlist",[]),d.module("d2-headerbar",[]),d.module("d2-directives",["d2-breadcrumbs","d2-introlist","d2-headerbar","d2-datatable"]),d.module("d2",["d2-services","d2-directives","d2-filters"])}(angular,window.d2=window.d2||{});
