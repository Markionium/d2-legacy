...
"use strict";!function(t,e){var a=t.module("d2-datatable");a.controller("DataTableController",["$scope","$q","$filter","$timeout",function(a,i,r,n){var s=this;this.localData=!0,this.origData=[],a.items=[],this.getHeadersFromData=function(){var t=[];return _.map(a.items,function(e){var a=e.getDataOnly?e.getDataOnly():e;return _.map(a,function(e,a){t.push({name:a})}),t}),t=_.uniq(t,function(t){return t.name}),a.columns=t,a.columns},this.parseTableConfig=function(){var t=a.tableConfig||{};a.pageItems=t.pageItems,a.columns=t.columns||e},this.parseTableData=function(){t.isArray(a.tableData)&&a.tableData.getList!==e&&(this.localData=!1,a.d2Service=a.tableData,a.tableData=a.d2Service.getList(this.getRemoteParams())),i.when(a.tableData).then(this.processData.bind(this))},this.processData=function(t){a.items=this.origData=t,a.columns=a.columns||this.getHeadersFromData(),a.pageItems&&(a.items=a.items.slice(0,a.pageItems))},this.setSortOrder=function(i){var r=t.copy(a.columns);t.forEach(r,function(t){t.sort=t.name===i.name?"asc"===i.sort?"desc":"asc":e}),a.columns=r},this.getColumnsWithFilters=function(){return _.filter(a.columns,"searchable")},this.getFilterObject=function(){var e=this.getColumnsWithFilters(),a={};return 0===e.length?!1:(t.forEach(e,function(t){a[t.name]=t.filter}),a)},this.getRemoteFilters=function(){var a=[];if(this.getFilterObject())return t.forEach(this.getFilterObject(),function(t,e){t&&a.push(e+":like:"+t)}),a.length>0?a:e},this.getRemoteParams=function(){var t={},a=this.getRemoteFilters();return a&&(t.filter=a),a?t:e},this.requestNewDataFromService=function(){var t=this.getRemoteParams();a.tableData=a.d2Service.getList(t),i.when(a.tableData).then(this.processData.bind(this))},this.doLocalFiltering=function(){this.getFilterObject()&&(a.items=r("filter")(this.origData,this.getFilterObject()))},this.doLocalSorting=function(){var t,e=_.filter(a.columns,"sort"),i=_.pluck(e,"name");0!==e.length&&(t=_.sortBy(a.items,i),e[0]&&"desc"===e[0].sort&&(t=t.reverse()),a.items=t)},this.serviceSorting=function(){{var t=_.filter(a.columns,"sort");_.pluck(t,"name")}0!==t.length&&alert("API Sorting not yet implemented")};var o=!1;a.$watch("columns",function(t,e){e!==t&&(s.localData&&(s.doLocalFiltering(),s.doLocalSorting()),a.d2Service&&(o||(n(function(){s.requestNewDataFromService(),o=!1},300),o=!0)))},!0)}]),a.directive("d2DataTable",function(){return{restrict:"E",replace:!0,scope:{tableConfig:"=",tableData:"="},templateUrl:d2.utils.scriptPath()+"common/datatable/datatable.html",controller:"DataTableController",link:function(t,e,a,i){i.parseTableConfig(),i.parseTableData()}}})}(angular);
"use strict";!function(e){var n=e.module("d2-datatable");n.directive("d2DataTableHeader",function(){return{restrict:"AC",replace:!0,require:"^d2DataTable",transclude:!0,scope:{column:"="},template:'<th class="table-header"><a ng-click="sortOrder()" href="#" ng-if="column.sortable" ng-transclude ng-class="\'sorting-\' + column.sort"></a><span ng-if="!column.sortable" ng-transclude></span><input ng-if="column.searchable" ng-model="column.filter" type="search"></th>',link:function(e,n,r,t){e.sortOrder=function(){t.setSortOrder(e.column)}}}})}(angular);
