...
"use strict";!function(e){var n=e.module("d2-datatable");n.directive("d2DataTableHeader",function(){return{restrict:"AC",replace:!0,require:"^d2DataTable",transclude:!0,scope:{column:"="},template:'<th class="table-header"><a href="#" ng-if="column.sortable" ng-transclude ng-class="\'sorting-\' + column.sort"></a><span ng-if="!column.sortable" ng-transclude></span><input ng-change="doSearch" ng-if="column.searchable" ng-model="column.filter" type="search"></th>',link:function(e,n,t,r){e.sortOrder=function(n){r.setSortOrder(e.column),n.preventDefault()},n.bind("click",e.sortOrder),e.doSearch=function(n){console.log(e.column),r.setSearchOnColumn(e.column),n.preventDefault()}}}})}(angular);
