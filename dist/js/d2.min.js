"use strict";!function(d){d.module("d2-services",["d2-rest"]),d.module("d2-filters",[]),d.module("d2-datatable",["d2-filters"]),d.module("d2-breadcrumbs",[]),d.module("d2-introlist",[]),d.module("d2-headerbar",[]),d.module("d2-directives",["d2-breadcrumbs","d2-introlist","d2-headerbar","d2-datatable"]),d.module("d2",["d2-services","d2-directives","d2-filters"])}(angular,window.d2=window.d2||{});
"use strict";!function(r){r.module("d2-breadcrumbs").directive("d2BreadCrumbs",function(){return{restrict:"E",replace:!0,scope:!0,templateUrl:"common/breadcrumbs/breadcrumbs.html",controller:["$scope","d2BreadCrumbsService",function(c,e){c.crumbsList=e.getCrumbsList(),c.crumbClick=function(t){e.resetCrumbs(t.id),c.crumbsList=e.getCrumbsList(),t.click&&t.click(r.copy(t))}}]}})}(angular);
...
"use strict";!function(t){var a=t.module("d2-datatable");a.controller("DataTableController",["$scope","$q",function(t,a){this.getHeadersFromData=function(){var a=[];return _.map(t.items,function(t){var e=t.getDataOnly?t.getDataOnly():t;return _.map(e,function(t,e){a.push(e)}),a}),a=_.uniq(a),t.columns=a,t.columns},this.parseTableConfig=function(){var a=t.tableConfig||{};t.pageItems=a.pageItems},this.parseTableData=function(){a.when(t.tableData).then(this.processData.bind(this))},this.processData=function(a){t.items=a,t.columns=t.columns||this.getHeadersFromData(),t.pageItems&&(t.items=t.items.slice(0,t.pageItems))}}]),a.directive("d2DataTable",function(){return{restrict:"E",replace:!0,scope:{tableConfig:"=",tableData:"="},templateUrl:"common/datatable/datatable.html",controller:"DataTableController",link:function(t,a,e,n){n.parseTableConfig(),n.parseTableData()}}})}(angular);
