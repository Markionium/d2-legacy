"use strict";!function(e,d){d.utils={scriptPath:function(){var d;return function(){var t,r,s=e.element('<script src=""></script>');return d?d:(t=document.getElementsByTagName("script"),e.forEach(t,function(e){/d2(\.min)?\.js$/i.test(e.src)&&(s=e)}),r=s.src||"",d=r.substring(0,r.lastIndexOf("/")+1))}}()},e.module("d2-services",["d2-rest"]),e.module("d2-filters",[]),e.module("d2-datatable",["d2-filters","d2-typeahead"]),e.module("d2-breadcrumbs",[]),e.module("d2-introlist",[]),e.module("d2-headerbar",[]),e.module("d2-directives",["d2-breadcrumbs","d2-introlist","d2-headerbar","d2-datatable"]),e.module("d2",["d2-services","d2-directives","d2-filters"])}(angular,window.d2=window.d2||{});
...
"use strict";!function(t,e){var a=t.module("d2-datatable");a.controller("DataTableController",["$scope","$q","$filter","$timeout","d2TypeAheadService",function(a,i,n,r,s){var o=this;this.localData=!0,this.origData=[],this.typeAheadCache=s,a.items=[],this.getHeadersFromData=function(){var t=[];return _.map(a.items,function(e){var a=e.getDataOnly?e.getDataOnly():e;return _.map(a,function(e,a){t.push({name:a})}),t}),t=_.uniq(t,function(t){return t.name}),a.columns=t,a.columns},this.parseTableConfig=function(){var t=a.tableConfig||{};a.pageItems=t.pageItems,a.columns=t.columns||e},this.parseTableData=function(){t.isArray(a.tableData)&&a.tableData.getList!==e&&(this.localData=!1,a.d2Service=a.tableData,a.tableData=a.d2Service.getList(this.getRemoteParams())),i.when(a.tableData).then(this.processData.bind(this))},this.processData=function(e){a.items=this.origData=e,a.columns=a.columns||this.getHeadersFromData(),a.pageItems&&(a.items=a.items.slice(0,a.pageItems)),t.forEach(a.columns,function(t){o.typeAheadCache.add(t.name,o.getValuesForColumn(t))})},this.setSortOrder=function(i){var n=t.copy(a.columns);t.forEach(n,function(t){t.sort=t.name===i.name?"asc"===i.sort?"desc":"asc":e}),a.columns=n},this.getColumnsWithFilters=function(){return _.filter(a.columns,"searchable")},this.getFilterObject=function(){var e=this.getColumnsWithFilters(),a={};return 0===e.length?!1:(t.forEach(e,function(t){a[t.name]=t.filter}),a)},this.getRemoteFilters=function(){var a=[];if(this.getFilterObject())return t.forEach(this.getFilterObject(),function(t,e){t&&a.push(e+":like:"+t)}),a.length>0?a:e},this.getRemoteParams=function(){var t={},a=this.getRemoteFilters();return a&&(t.filter=a),a?t:e},this.requestNewDataFromService=function(){var t=this.getRemoteParams();a.tableData=a.d2Service.getList(t),i.when(a.tableData).then(this.processData.bind(this))},this.doLocalFiltering=function(){this.getFilterObject()&&(a.items=n("filter")(this.origData,this.getFilterObject()))},this.doLocalSorting=function(){var t,e=_.filter(a.columns,"sort"),i=_.pluck(e,"name");0!==e.length&&(t=_.sortBy(a.items,i),e[0]&&"desc"===e[0].sort&&(t=t.reverse()),a.items=t)},this.serviceSorting=function(){{var t=_.filter(a.columns,"sort");_.pluck(t,"name")}0!==t.length&&alert("API Sorting not yet implemented")},this.getValuesForColumn=function(e){return e&&e.name&&t.isString(e.name)?_.map(a.items,function(t){return t[e.name]}):[]};var l=!1;a.$watch("columns",function(t,e){e!==t&&(o.localData&&(o.doLocalFiltering(),o.doLocalSorting()),a.d2Service&&(l||(r(function(){o.requestNewDataFromService(),l=!1},300),l=!0)))},!0)}]),a.directive("d2DataTable",function(){return{restrict:"E",replace:!0,scope:{tableConfig:"=",tableData:"="},templateUrl:d2.utils.scriptPath()+"common/datatable/datatable.html",controller:"DataTableController",link:function(t,e,a,i){i.parseTableConfig(),i.parseTableData()}}})}(angular);
"use strict";!function(e){var t=e.module("d2-datatable");t.directive("d2DataTableHeader",function(){return{restrict:"AC",replace:!0,require:"^d2DataTable",transclude:!0,scope:{column:"="},template:'<th class="table-header"><a ng-click="sortOrder()" href="#" ng-if="column.sortable" ng-transclude ng-class="\'sorting-\' + column.sort"></a><span ng-if="!column.sortable" ng-transclude></span><input ng-if="column.searchable" ng-model="column.filter" type="text" typeahead="name for name in getTypeAheadFor(column) | filter:$viewValue | limitTo:8"></th>',link:function(e,t,n,a){e.sortOrder=function(){a.setSortOrder(e.column)},e.getTypeAheadFor=function(e){return a.typeAheadCache[e.name]}}}})}(angular);
