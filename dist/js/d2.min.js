...
"use strict";!function(t,e){var a=t.module("d2-datatable");a.controller("DataTableController",["$scope","$q",function(a,n){this.getHeadersFromData=function(){var t=[];return _.map(a.items,function(e){var a=e.getDataOnly?e.getDataOnly():e;return _.map(a,function(e,a){t.push({name:a})}),t}),t=_.uniq(t,function(t){return t.name}),a.columns=t,a.columns},this.parseTableConfig=function(){var t=a.tableConfig||{};a.pageItems=t.pageItems,a.columns=t.columns||e},this.parseTableData=function(){n.when(a.tableData).then(this.processData.bind(this))},this.processData=function(t){a.items=t,a.columns=a.columns||this.getHeadersFromData(),a.pageItems&&(a.items=a.items.slice(0,a.pageItems))},this.setSortOrder=function(n){var s=t.copy(a.columns);t.forEach(s,function(t){t.sort=t.name===n.name?"asc"===n.sort?"desc":"asc":e}),a.columns=s},a.$watch("columns",function(t,e){if(e!==t&&a.items.length>0){var n,s=_.filter(a.columns,"sort"),o=_.pluck(s,"name");if(0===s.length)return;n=_.sortBy(a.items,o),s[0]&&"desc"===s[0].sort&&(n=n.reverse()),a.items=n,console.log(a.items)}},!0)}]),a.directive("d2DataTable",function(){return{restrict:"E",replace:!0,scope:{tableConfig:"=",tableData:"="},templateUrl:d2.utils.scriptPath()+"common/datatable/datatable.html",controller:"DataTableController",link:function(t,e,a,n){n.parseTableConfig(),n.parseTableData()}}})}(angular);
"use strict";!function(e){var t=e.module("d2-datatable");t.directive("d2DataTableHeader",function(){return{restrict:"AC",replace:!0,require:"^d2DataTable",transclude:!0,scope:{column:"="},template:'<th class="table-header"><a href="#" ng-if="column.sortable" ng-transclude ng-class="\'sorting-\' + column.sort"></a><span ng-if="!column.sortable" ng-transclude></span></th>',link:function(e,t,r,n){e.sortOrder=function(t){console.log("click"),n.setSortOrder(e.column),e.$digest(),t.preventDefault()},t.bind("click",e.sortOrder)}}})}(angular);
